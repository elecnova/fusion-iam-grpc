...
const (
	DomainService_CreateDomain_FullMethodName      = "/fusion.proto.domain.DomainService/CreateDomain"
	DomainService_UpdateDomain_FullMethodName      = "/fusion.proto.domain.DomainService/UpdateDomain"
	DomainService_DeleteDomain_FullMethodName      = "/fusion.proto.domain.DomainService/DeleteDomain"
	DomainService_GetDomain_FullMethodName         = "/fusion.proto.domain.DomainService/GetDomain"
	DomainService_GetDomainByDomain_FullMethodName = "/fusion.proto.domain.DomainService/GetDomainByDomain"
	DomainService_ListDomains_FullMethodName       = "/fusion.proto.domain.DomainService/ListDomains"
)
...
type DomainServiceClient interface {
	...
	// 更新域名
	UpdateDomain(ctx context.Context, in *UpdateDomainRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 删除域名
	...
	// 根据域名查询详情
	GetDomainByDomain(ctx context.Context, in *GetDomainByDomainRequest, opts ...grpc.CallOption) (*DomainResponse, error)
	// 域名分页列表查询
...
func (c *domainServiceClient) UpdateDomain(ctx context.Context, in *UpdateDomainRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *domainServiceClient) GetDomain(ctx context.Context, in *GetDomainRequest, opts ...grpc.CallOption) (*DomainResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *domainServiceClient) GetDomainByDomain(ctx context.Context, in *GetDomainByDomainRequest, opts ...grpc.CallOption) (*DomainResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DomainResponse)
	err := c.cc.Invoke(ctx, DomainService_GetDomainByDomain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DomainServiceServer interface {
	...
	// 更新域名
	UpdateDomain(context.Context, *UpdateDomainRequest) (*emptypb.Empty, error)
	// 删除域名
	...
	// 根据域名查询详情
	GetDomainByDomain(context.Context, *GetDomainByDomainRequest) (*DomainResponse, error)
	// 域名分页列表查询
...
func (UnimplementedDomainServiceServer) UpdateDomain(context.Context, *UpdateDomainRequest) (*emptypb.Empty, error) {
...
func (UnimplementedDomainServiceServer) GetDomain(context.Context, *GetDomainRequest) (*DomainResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDomain not implemented")
}
func (UnimplementedDomainServiceServer) GetDomainByDomain(context.Context, *GetDomainByDomainRequest) (*DomainResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDomainByDomain not implemented")
}
...
func _DomainService_GetDomainByDomain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDomainByDomainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DomainServiceServer).GetDomainByDomain(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DomainService_GetDomainByDomain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DomainServiceServer).GetDomainByDomain(ctx, req.(*GetDomainByDomainRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DomainService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fusion.proto.domain.DomainService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDomainByDomain",
			Handler:    _DomainService_GetDomainByDomain_Handler,
		},
		{
	...
	Metadata: "domain/domain_service.proto",
}
