...
func (c *dictionaryServiceClient) GetDictByID(ctx context.Context, in *GetDictByIDRequest, opts ...grpc.CallOption) (*GetDictResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDictResponse)
	err := c.cc.Invoke(ctx, DictionaryService_GetDictByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dictionaryServiceClient) GetDictByKey(ctx context.Context, in *GetDictByKeyRequest, opts ...grpc.CallOption) (*GetDictResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDictResponse)
...
func (UnimplementedDictionaryServiceServer) GetDictByID(context.Context, *GetDictByIDRequest) (*GetDictResponse, error) {
...
func _DictionaryService_GetDictByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDictByIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DictionaryServiceServer).GetDictByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DictionaryService_GetDictByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DictionaryServiceServer).GetDictByID(ctx, req.(*GetDictByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DictionaryService_GetDictByKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDictByKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DictionaryServiceServer).GetDictByKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DictionaryService_GetDictByKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DictionaryService_GetDictByID_Handler,
		},
		{
